  ...
  return (
    <div className="relative h-full flex flex-col items-center justify-between py-8 overflow-hidden bg-gradient-to-b from-gray-900 to-gray-800">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className={`absolute inset-0 opacity-20 transition-colors duration-500 bg-gradient-to-r ${selectedMode.gradientStyle}`}
        />
          ...
          {Array.from({ length: 20 }).map((_, i) => (
            <div
              ...
              className={`
                ...
                animate-float-slow
                ${
                  selectedMode.color.accent === "blue-500"
                    ? "bg-blue-400"
                    : selectedMode.color.accent === "green-500"
                    ? "bg-green-400"
                    : "bg-yellow-400"
                }
                opacity-30
